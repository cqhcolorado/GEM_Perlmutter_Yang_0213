...
!$omp target enter data map(alloc:mu,xii,pzi,eki,z0i,u0i,g0i)
#endif
...
#ifdef OPENMP
!$omp target enter data map(alloc:x2e,y2e,z2e,u2e,u3e,x3e,y3e,z3e,w2e,w3e)
!$omp target enter data map(alloc:mue,mue2,mue3,xie,pze,eke,z0e,u0e,g0e)
!$omp target enter data map(alloc:ipass,index,w000,w001,w010,w011,w100,w101,w110,w111)
#endif
